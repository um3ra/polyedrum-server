...
alter table buckets_products
    add constraint bucket_products_fk_product foreign key (product_id) references products (id);
alter table buckets_products
    add constraint bucket_products_fk_bucket foreign key (bucket_id) references buckets (id);
alter table genres
